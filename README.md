...
<p align="center">
  ...
  &nbsp;
  <a href="CHANGELOG.md"><img alt="Version" src="https://img.shields.io/badge/v0.9.9-78e08f?style=for-the-badge&labelColor=0d3b4f"></a>
  &nbsp;
...
- **Three prestige layers** — Schematics (per-run), Patents (meta, survives each publish), Legacy Marks (endgame, survives every reset including publish)
...
- **79 achievements** with progress bars and stacking passive bonuses, capped by a `◆◆◆ PERFECTIONIST` meta that requires earning every other one
...
See [CHANGELOG.md](CHANGELOG.md) for the full version history. The current release is **v0.9.9**.
